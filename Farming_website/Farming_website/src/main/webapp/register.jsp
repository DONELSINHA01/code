...
try
{
	...
	if(request.getParameter("btn_register")!=null) //check register button click event not null
	{
		...
		pstmt=con.prepareStatement("insert into login(firstname,lastname,email,password,phone,land) values(?,?,?,?,?,?)"); //sql insert query
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-row">
                        <label>
                            ...
                            <input type="number" name="txt_phone" id="phnumber" placeholder="Enter Number">
                        </label>
                    </div>
                        ...
                        <label>
                            ...
                            <input type="number" name="txt_land" id="land" placeholder="Enter Total Land">
                        </label>
                    </div>
